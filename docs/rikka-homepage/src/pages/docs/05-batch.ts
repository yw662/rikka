  ...
  render() {
    return div(
      ...
      div(
        ...
        sharedStyles.advancedBadge("Batch Updates", "is an advanced topic. Rikka batches updates automatically — you rarely need to think about this behavior explicitly."),
      div(
        { class: "doc-section" },
