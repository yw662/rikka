...
export const homeContent = {
  // Hero
  heroBadgeTC39: { en: "AI Coding First", zh: "AI Coding First" } as Record<
    Locale,
    string
  >,
  heroBadgeZeroVDOM: { en: "TC39 Signals", zh: "TC39 Signals" } as Record<
    Locale,
    string
  >,
  heroBadgeZeroRuntime: { en: "Zero VDOM", zh: "零虚拟DOM" } as Record<
    Locale,
    string
  >,
  heroTagline: {
    en: "Native Reactivity for the Web",
    zh: "为 Web 而生的原生响应式",
  } as Record<Locale, string>,
  heroDesc: {
    en: "Function-based defineElement, no decorators, full TypeScript inference. Ships llms.txt + Agent Skills as part of the project structure.",
    zh: "函数式 defineElement，无需装饰器，完整 TypeScript 推断。将 llms.txt + Agent Skills 内置进项目结构。",
  } as Record<Locale, string>,
  heroCtaGetStarted: { en: "Get Started →", zh: "开始使用 →" } as Record<
    Locale,
    string
  >,
  heroCtaViewExamples: { en: "View Examples", zh: "查看示例" } as Record<
    Locale,
    string
  >,
  heroStatCdn: { en: "CDN bundle (gzip)", zh: "CDN 包 (gzip)" } as Record<
    Locale,
    string
  >,
  heroStatVDOM: { en: "Virtual DOM overhead", zh: "虚拟DOM 开销" } as Record<
    Locale,
    string
  >,
  heroStatStandards: { en: "Standards based", zh: "基于标准" } as Record<
    Locale,
    string
  >,
  heroStatTypeScript: { en: "TypeScript", zh: "TypeScript" } as Record<
    Locale,
    string
  >,

  // AI section
  aiEyebrow: { en: "For AI Agents", zh: "面向 AI 智能体" } as Record<
    Locale,
    string
  >,
  aiTitle: {
    en: "Built for the AI coding era",
    zh: "为 AI 编程时代而生",
  } as Record<Locale, string>,
  aiDesc: {
  ...
  aiCtaSkills: { en: "Read the skills →", zh: "阅读 Skills →" } as Record<
    Locale,
    string
  >,
  aiCtaPlayground: {
  ...
  // Features section
  featuresEyebrow: { en: "Why Rikka", zh: "为什么选择 Rikka" } as Record<
    Locale,
    string
  >,
  featuresTitle: {
    en: "Built for the modern web",
    zh: "为现代 Web 而构建",
  } as Record<Locale, string>,
  featuresSubtitle: {
  ...
  featureFineGrainedTitle: { en: "TC39 Signals", zh: "TC39 Signals" } as Record<
    Locale,
    string
  >,
  ...
  featureLLMTitle: { en: "AI Coding First", zh: "AI Coding First" } as Record<
    Locale,
    string
  >,
  featureLLMDesc: {
    en: "Ships llms.txt + 14 Agent Skills + AGENTS.md as part of the project structure. Agents write correct Rikka code on the first try.",
    zh: "将 llms.txt + 14 个 Agent Skills + AGENTS.md 内置到项目结构中。AI 智能体一次写出正确的 Rikka 代码。",
  } as Record<Locale, string>,
  featureZeroRuntimeTitle: {
    en: "Function-Based API",
    zh: "函数式 API",
  } as Record<Locale, string>,
  ...
  featureTemplateTitle: { en: "Template System", zh: "模板系统" } as Record<
    Locale,
    string
  >,
  ...
  featureTypeSafeTitle: {
    en: "Full TS Inference",
    zh: "完整 TS 推断",
  } as Record<Locale, string>,
  featureTypeSafeDesc: {
  ...
  featureWebStandardsTitle: { en: "Web Standards", zh: "Web 标准" } as Record<
    Locale,
    string
  >,
  ...
  demoTitle: {
    en: "Edit code. See results instantly.",
    zh: "编辑代码，即时查看结果。",
  } as Record<Locale, string>,
  demoSubtitle: {
  ...
  advantageFineGrainedTitle: {
    en: "Fine-Grained Updates",
    zh: "细粒度更新",
  } as Record<Locale, string>,
  ...
  // Comparison table
  comparisonTitle: { en: "Framework Comparison", zh: "框架对比" } as Record<
    Locale,
    string
  >,
  comparisonRuntime: { en: "Runtime (gzip)", zh: "运行时 (gzip)" } as Record<
    Locale,
    string
  >,
  comparisonVirtualDOM: { en: "Virtual DOM", zh: "虚拟DOM" } as Record<
    Locale,
    string
  >,
  comparisonReactivity: { en: "Reactivity", zh: "响应式" } as Record<
    Locale,
    string
  >,
  comparisonBuildStep: { en: "Build Step", zh: "构建步骤" } as Record<
    Locale,
    string
  >,
  comparisonWebStandards: { en: "Web Standards", zh: "Web 标准" } as Record<
    Locale,
    string
  >,
  comparisonTypeSafe: { en: "Type Safe", zh: "类型安全" } as Record<
    Locale,
    string
  >,
  comparisonAgentDocs: { en: "AI / LLM docs", zh: "AI / LLM 文档" } as Record<
    Locale,
    string
  >,
  comparisonAgentDocsRikka: {
    en: "llms.txt + skills + AGENTS.md",
    zh: "llms.txt + skills + AGENTS.md",
  } as Record<Locale, string>,
  ...
  comparisonCompiled: { en: "Compiled", zh: "编译型" } as Record<
    Locale,
    string
  >,
  comparisonProperties: { en: "Properties", zh: "属性" } as Record<
    Locale,
    string
  >,
  comparisonCaption: {
  ...
  tagsTitle: { en: "Everything You Need", zh: "你所需的一切" } as Record<
    Locale,
    string
  >,
  tagsSubtitle: {
  ...
  tagCustomElements: { en: "Custom Elements", zh: "自定义元素" } as Record<
    Locale,
    string
  >,
  tagShadowDOM: { en: "Shadow DOM", zh: "Shadow DOM" } as Record<
    Locale,
    string
  >,
  tagTemplates: { en: "Templates", zh: "模板" } as Record<Locale, string>,
  tagFineGrainedUpdates: {
    en: "Fine-Grained Updates",
    zh: "细粒度更新",
  } as Record<Locale, string>,
  tagTypeScript: { en: "TypeScript", zh: "TypeScript" } as Record<
    Locale,
    string
  >,
  tagDecorators: { en: "Decorators", zh: "装饰器" } as Record<Locale, string>,
  tagReactiveLists: { en: "Reactive Lists", zh: "响应式列表" } as Record<
    Locale,
    string
  >,
  tagNoVDOM: { en: "No VDOM", zh: "无虚拟DOM" } as Record<Locale, string>,
  tagTreeShakable: { en: "Tree Shakable", zh: "可 Tree-shake" } as Record<
    Locale,
    string
  >,

  // Quick start section
  quickStartEyebrow: { en: "Get started", zh: "快速开始" } as Record<
    Locale,
    string
  >,
  quickStartTitle: {
    en: "Three steps. Zero config.",
    zh: "三步搞定。零配置。",
  } as Record<Locale, string>,
  quickStartSubtitle: {
  ...
  quickStartStep1Desc1: {
    en: "Choose your preferred method — npm, a ",
    zh: "选择你喜欢的方式——npm、",
  } as Record<Locale, string>,
  quickStartStep1Desc2: {
    en: " tag, or ES module import:",
    zh: " 标签，或 ES 模块导入：",
  } as Record<Locale, string>,
  quickStartStep2Title: { en: "Write", zh: "编写" } as Record<Locale, string>,
  quickStartStep2Desc1: { en: "Use ", zh: "使用 " } as Record<Locale, string>,
  quickStartStep2Desc2: {
    en: ", and signals to build your UI. ",
    zh: " 和信号来构建 UI。",
  } as Record<Locale, string>,
  quickStartStep2Desc3: {
    en: " for reusable components (optional).",
    zh: " 用于可复用组件（可选）。",
  } as Record<Locale, string>,
