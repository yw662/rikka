...
import './pages/docs/19-composition';
import './pages/docs/20-fine-grained';
import './pages/docs/23-style-template';
import './pages/docs/22-store';
...
const RikkaApp = defineElement('rikka-app', {
  ...
  render() {
    ...
    const appEl = div({ class: 'app' }, navEl, mainLayout);
